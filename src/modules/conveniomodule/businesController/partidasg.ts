...
class BussPartida{
    ...
    public async readPartida(query: any, skip: number, limit: number): Promise<Array<IPartidas>>;

    public async readPartida(params1?: string | any, params2?: number, params3?: number): Promise<Array<IPartidas> | IPartidas> {
        if (params1 && typeof params1 == "string") {
            ...
            let listPartida: Array<IPartidas> = await partidasModel.find(params1).skip(skip).limit(limit);
            return listPartida;
        } else {
    ...
    public async readPartidaCod(params1?: number | any, params2?: number, params3?: number): Promise<Array<IPartidas> | IPartidas> {
        if (params1) {
