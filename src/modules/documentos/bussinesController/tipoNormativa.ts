...
class BussTipoNormativa {
    ...
    public async readTipoNormativa(
      ...
      if (params1 && typeof params1 == "string") {
        var result: ITipoNormativa = (await modelTipoNormativa.findOne({ _id: params1 })).populate("normativa");
        return result;
      } else if (params1) {
        let skip = params2;
        let limit = params3;
        ...
        let listTipoNormativas: Array<ITipoNormativa> = await modelTipoNormativa.find().populate("normativa");
