...
export const printDetailDesemGasto = (
  options: any,
  user: any
): TDocumentDefinitions => {

  const values = options;
  log("printDetailDesemGasto", values.gastos);
  ...
  const docDefinition: TDocumentDefinitions = {
    ...
    content: [
      ...
      {
        text: "II. Detalle de Saldos de Fuentes de Financiamiento",
        style: "subTitle",
        decoration: "underline",
      },
      // DETALLE DE REGISTRO de Fuentes
      {
        ...
        table: {
          ...
          body: [
            ...
            ...desemFuentes.map((desemFuente: any, indice: number) => [
              ...
              {
                text: `${CurrencyFormatter.formatCurrency(
                  (desemFuente.montoGasto / desemFuente.montoTotal) * 100
                )}%`,
                style: "tableBody",
                alignment: "right",
              },
