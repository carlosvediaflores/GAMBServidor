...
export const printQueryEntidades = (options: any): TDocumentDefinitions => {
  const values = options;
  const user = values.user;
  const filter = values.filter;
  log("values", values.filter);
  const desemFuentes = values.idFuentes || [];
  const entidades = values.entidades || [];
  ...
  const docDefinition: TDocumentDefinitions = {
    ...
    content: [
      ...
      // },
      {
        text: "I. Lista de Entidades Registradas",
        style: "subTitle",
        decoration: "underline",
      },
        ...
        table: {
          ...
          body: [
            [
              ...
              { text: "Sigla", style: "tableHeader" },
              // { text: "%", style: "tableHeader" },
            ],
            ...entidades.map((entidad: any, indice: number) => [
